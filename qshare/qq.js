! function(a, b, c) {
	...
	function d(a, b) {
		var c, d, e, f;
		for (a = String(a).split("."), b = String(b).split("."), c = 0, f = Math.max(a.length, b.length); c < f; c++) {
			if (d = isFinite(a[c]) && Number(a[c]) || 0, e = isFinite(b[c]) && Number(b[c]) || 0, d < e) return -1;
			if (d > e) return 1
		}
		return 0
	}
	...
	function f(b, c, d, e, f) {
		if (b && c && d) {
			...
			if (e = e || [], !f || !O[f] && !window[f])
				for (f = null, h = 0, i = e.length; h < i; h++)
			...
			f && (P[f] = {
				...
				uri: k,
				startTime: Date.now()
			}, (j = String(f).match(/__MQQ_CALLBACK_(\d+)/)) && (P[j[1]] = P[f])), C.send(k, T)
		}
	}
	...
	function h(b, c, d) {
		var e, f;
		if (b = a.isFunction(b) ? b : window[b]) return e = i(b), f = "__MQQ_CALLBACK_" + e, window[f] = function() {
	...
	function k(d, f, g, h) {
		...
		f = f || [], i = f[0], a.isUndefined(h) && (h = !0), a.isObject(i) && ("data" in i || (i.data = c({}, i)), "code" in i || (i.code = j(i) || 0), i.msg = i.msg || ""), a.isFunction(m) ? h ? setTimeout(function() {
			m.apply(null, f)
		}, 0) : m.apply(null, f) : console.log("mqqapi: not found such callback: " + d + " or the callback: " + d + " had some errors! API: " + (d && d.name || "")), g && (delete O[d], delete window["__MQQ_CALLBACK_" + d]), P[d] && (l = P[d], delete P[d], e({
			from: "fireCallback",
			ns: l.ns,
			method: l.method,
	...
	function n(b, c) {
		var d = null,
			...
			j = f[f.length - 1],
			k = g(b.substring(0, h));
		k[j] && !a.debuging || ((d = c[a.platform]) || "browser" === e || ((d = a.iOS && c.iOS) ? e = "iOS" : (d = a.android && c.android) && (e = "android")), d && c.supportInvoke && (R[i + "." + j] = d), k[j] = d || m, c.support && c.support[e] && (Q[i + "." + j] = c.support[e]))
	}

	function o(b) {
		var c, d, e = b.split("."),
			f = e[e.length - 2] + "." + e[e.length - 1];
		return c = Q[f] || Q[b.replace("qw.", "mqq.").replace("qa.", "mqq.")], a.isObject(c) && (c = c[a.iOS ? "iOS" : a.android ? "android" : "browser"]), !! c && (d = c.split("-"), 1 === d.length ? a.compare(d[0]) > -1 : a.compare(d[0]) > -1 && a.compare(d[1]) < 1)
	}
	...
	function p(c, d, f, g) {
		...
		var i;
		document.createElement("iframe").style.cssText = "display:none;width:0px;height:0px;";
		var i, j, k = (a.android && a.compare("6.2.0") >= 0 && M.test(D), document.createElement("iframe"));
		k.style.cssText = "display:none;width:0px;height:0px;", k.onerror = function(a) {
			a.stopPropagation()
		}, a.iOS && (k.onload = h, k.src = c);
		var m = document.body || document.documentElement;
		return m.appendChild && m.appendChild(k), a.android && (k.onload = h, k.src = c), j = c.indexOf("mqqapi://") > -1 && a.android ? 0 : 500, setTimeout(function() {
			k && k.parentNode && k.parentNode.removeChild(k)
		}, j), i = a.__RETURN_VALUE, a.__RETURN_VALUE = b, i
	}
	...
	function B(b, c, d) {
		...
		a.android && !1 === g.options.broadcast && a.compare("5.2") <= 0 && (g.options.domains = ["localhost"], g.options.broadcast = !0), "browser" !== a.platform && (e = "jsbridge://event/dispatchEvent?p=" + encodeURIComponent(JSON.stringify(g) || ""), p(e, "event", "dispatchEvent"), f("jsbridge", "event", "dispatchEvent"))
	}
	var C, D = navigator.userAgent,
		...
		M = /\bTBS\/([\d]+)/,
		N = /\bTribe\/([\d\.]+)/,
		O = a.__aCallbacks || {}, P = a.__aReports || {}, Q = a.__aSupports || {}, R = a.__aFunctions || {}, S = 1,
		T = -1e5,
		U = {
			qbizApi: "5.0",
			pay: "999999",
	...
	return E ? (a.debuging = !0, D = E.ua || D) : a.debuging = !1, c(a, function() {
		...
		function c(a, c, h) {
			c === T && (c = 0, 1 != Math.round(Math.random() * j) % j) || (d.push([a, c || 0, h || 0]), f || (g = Date.now(), f = setTimeout(b, e)))
		}
		var d = [],
			e = 500,
			f = 0,
...
function(a) {
	...
	iOS: function(a, b) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("app", "isInstalled", {
			scheme: a
		}, b);
	...
	iOS: function(a, b) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("app", "batchIsInstalled", {
			schemes: a
		}, b);
...
function() {
	...
	window.clientCallback = function(a, c) {
		...
		iOS: function(a, b) {
			var c = a.url,
				d = a.params || {}, e = a.options || {}, f = a.context;
			d._t = +new Date;
		...
		android: function(c, d) {
			var e = c.options || {}, f = e.method || "GET",
				g = {
					param: c.params,
					method: f
				};
	...
	iOS: function(a) {
		var b = {};
		if (mqq.__isWKWebView) mqq.invokeClient("data", "getClipboard", {
			callback: mqq.callback(a)
		});
		else {
			var c = mqq.invokeClient("data", "getClipboard", b);
			a && a(c)
		}
	},
	android: function(a) {
...
function() {
	var a = function(a, b) {
		return function(c) {
			b(1 == a || 16 == a || 17 == a ? c.friends || [] : c || {})
		}
	}, b = function(b, c) {
			c && (b.callback = mqq.callback(a(b.type, c))), mqq.invokeClient("qw_data", "getFriendInfo", b)
		};
...
function() {
	var a, b = {}, c = "object" == typeof tbs_bridge && "function" == typeof tbs_bridge.nativeExec,
		d = c ? tbs_bridge : null,
		e = function() {}, f = function(a) {
			...
			g && g.push(f), !a && c && (d.fireEvent = function(a, c) {
				...
				var f = b[a];
				if (f && f.length > 0) {
					for (d = 0, e = f.length; d < e; d++) f[d](c);
					b[a] = []
				}
			}, a = !0)
		}, h = function(a) {
			return "function" == typeof a ? function(b) {
				var c = -1,
					d = 0;
				"string" == typeof b && (b = JSON.parse(b)), "object" == typeof b && b.value && (c = 0, d = parseInt(b.value), d = d || 0), a && a({
					code: c,
					time: d
				})
			} : e
...
function() {
	...
	iOS: function(a) {
		if (mqq.compare("4.7.1") >= 0) return null == a && (a = !0), mqq.invokeClient("qw_debug", "hide", {
			flag: a
		})
	},
	android: function(a) {
	...
	iOS: function(a) {
		...
		if (b = "function" === d ? a.toString() : "string" === d ? a : "array" === d ? "[" + a.join() + "]" : JSON.stringify(a), mqq.compare("4.7.1") >= 0) return mqq.invokeClient("qw_debug", "log", {
			msg: b
		})
	},
	android: function(a) {
	...
	iOS: function(a) {
		if (mqq.compare("4.7.1") >= 0) return null == a && (a = !0), mqq.invokeClient("qw_debug", "show", {
			flag: a
		})
	},
	android: function(a) {
	...
	iOS: function() {
		if (mqq.compare("4.7.1") >= 0) return mqq.invokeClient("qw_debug", "start")
	},
	android: function() {
	...
	iOS: function() {
		if (mqq.compare("4.7.1") >= 0) return mqq.invokeClient("qw_debug", "stop")
	},
	android: function() {
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "qqVersion", a);
		mqq.invokeClient("device", "qqVersion", {
			callback: mqq.callback(a)
		})
	},
	supportInvoke: !0,
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "qqBuild", a);
		mqq.invokeClient("device", "qqBuild", {
			callback: mqq.callback(a)
		})
	},
	supportInvoke: !0,
	...
	iOS: function(a) {
		if (mqq.__isWKWebView) mqq.invokeClient("device", "getClientInfo", {
			callback: mqq.callback(a)
		});
		else {
			var b = {
			...
			if (mqq.__reportAPI("web", "device", "getClientInfo", null, c), "function" != typeof a) return b;
			mqq.__fireCallback(c, [b])
		}
	},
	android: function(a) {
		if (mqq.compare("4.6") >= 0) {
			...
			qqBuild: function(a) {
				return (a = a && a[1] || 0) && a.slice(a.lastIndexOf(".") + 1) || 0
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "systemName", a);
		mqq.invokeClient("device", "systemName", {
			callback: mqq.callback(a)
		})
	},
	supportInvoke: !0,
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "systemVersion", a);
		mqq.invokeClient("device", "systemVersion", {
			callback: mqq.callback(a)
		})
	},
	supportInvoke: !0,
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "model", a);
		mqq.invokeClient("device", "model", {
			callback: mqq.callback(a)
		})
	},
	supportInvoke: !0,
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "modelVersion", a);
		mqq.invokeClient("device", "modelVersion", {
			callback: mqq.callback(a)
		})
	},
	supportInvoke: !0,
	...
	iOS: function(a) {
		if (mqq.__isWKWebView) mqq.invokeClient("device", "getDeviceInfo", {
			callback: mqq.callback(a)
		});
		else {
			...
			if ("function" != typeof a) return c;
			mqq.__fireCallback(b, [c])
		}
	},
	android: function(a) {
		if (mqq.compare("4.6") >= 0) {
...
function() {
	function a(a, c) {
		if ("string" == typeof a && -1 != a.indexOf("Permission denied")) return c && c(a);
	...
	iOS: function(a) {
		if (mqq.__isWKWebView) mqq.invokeClient("device", "networkStatus", {
			callback: mqq.callback(a)
		});
		else {
			var b = mqq.invokeClient("device", "networkStatus");
			if (b = Number(b), "function" != typeof a) return b;
			mqq.__fireCallback(a, [b])
		}
	},
	android: function(a) {
	...
	iOS: function(a) {
		if (!mqq.__isWKWebView) return mqq.invokeClient("device", "webviewType", a);
		mqq.invokeClient("device", "webviewType", {
			callback: mqq.callback(a)
		})
	},
	android: function(a) {
...
function() {
	function a(a) {
		var b = null;
		if (!1 === e && (e = "" == location.search ? "" == location.hash ? "" : location.hash.substring(1) : location.search.substring(1), e = e.split("&"), e.length > 0))
	...
	function d(a, b) {
		if (0 == a.code) {
			...
			if (d = "object" != typeof d && "" != d ? JSON.parse(d) : d, void 0 !== d.msg)
...
function() {
	var a = function(a, b) {
		...
		for (var c = ["path", "service_type", "service_id", "act_id", "obj_id", "pay_amt"], d = 0, e = c.length; d < e; ++d)
			if (void 0 === a[c[d]]) return b({
				code: -1,
	...
	android: function(a) {
		var b = arguments[arguments.length - 1],
			c = "object" == typeof a ? a : {}, d = mqq.callback(function(a) {
				var c = -1,
					d = null,
					e = null;
				a && "null" !== a && (a = (a + "").split(","), 2 === a.length ? (c = 0, d = parseFloat(a[0] || 0), e = parseFloat(a[1] || 0)) : c = a[0]), b(c, e, d)
			}, !0);
...
function() {
	var a = function(a) {
		return function(b, c, d) {
			...
			if (0 === b) {
				var f = c;
				c = mqq.mapQuery(c), c.sp_data = f, c.attach && 0 === c.attach.indexOf("{") && (c.attach = JSON.parse(c.attach)), c.time_end && (c.pay_time = c.time_end), e.data = c
			} else 1 === b || -1 === b ? (e.retmsg = "用户主动放弃支付", e.resultCode = -1) : e.retmsg = c;
			a && a(e)
		}
	};
...
function() {
	...
	iOS: function(a) {
		mqq.__isWKWebView ? mqq.invokeClient("ui", "pageVisibility", {
			callback: mqq.callback(a)
	...
	iOS: function(a) {
		a && (!0 === a.visible ? mqq.invokeClient("nav", "showLoading") : !1 === a.visible && mqq.invokeClient("nav", "hideLoading"), a.color && mqq.invokeClient("nav", "setLoadingColor", {
			r: a.color[0],
			g: a.color[1],
			b: a.color[2]
		}))
